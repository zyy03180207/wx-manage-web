		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
				...
				<tr class="text-c">
					...
					<td><%=fans.getCid() %></td>
					<td class="text-l"><u style="cursor:pointer" class="text-primary" onClick="article_edit('查看','article-zhang.html','10001')" title="查看"><%=fans.getNickname() %></u></td>
					<td><%=fans.getCity() %></td>
					...
					<td>女性</td>
					<%} %>
					<td><%=format.format(new Date(Long.valueOf(fans.getSubscribeTime()) * 1000)) %></td>
					<%if(fans.getSubscribe()==0) { %>
					<td><span class="label label-fail radius">未关注</span></td>
					<%} else { %>
					<td><span class="label label-success radius">已关注</span></td>
					<%} %>
